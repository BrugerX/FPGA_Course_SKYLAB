...
HD_PWD='C:/Users/alber/OneDrive/Dokumenter/GitHub/FPGA_Course_SKYLAB/LIDAR/LIDAR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LidarTopMain.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LidarTopMain.tcl -notrace
