...
HD_PWD='C:/Users/alber/OneDrive/Dokumenter/GitHub/FPGA_Course_SKYLAB/LIDAR/LIDAR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LidarTopMain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LidarTopMain.tcl
